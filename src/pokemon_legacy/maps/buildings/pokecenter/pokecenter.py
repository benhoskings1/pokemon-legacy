...
from pokemon_legacy.engine.characters.character import CharacterTypes
...
from pokemon_legacy.engine.game_world.tiled_map import TiledMap2, GameObject, Obstacle, MapLinkTile
from pokemon_legacy.maps.buildings.pokecenter.pokecenter_containers import (
...
class PokeCenter(TiledMap2, MapLinkTile, StateMachine):
    ...
    def __init__(self, rect, player, map_scale=1, obj_scale=1, parent_map_scale=1.0):
        ...
        TiledMap2.__init__(
            self,
            os.path.join(ASSET_PATH, "maps/buildings/pokecenter/pokecenter.tmx"),
            size,
            player,
