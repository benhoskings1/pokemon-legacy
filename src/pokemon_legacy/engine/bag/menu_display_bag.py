...
from pokemon_legacy.engine.graphics.screen_V2 import BlitLocation, FontOption
from pokemon_legacy.engine.bag.bag import BagV2
from pokemon_legacy.engine.general.utils import Colours
from pokemon_legacy.engine.general.item import ItemType, Item
...
class MenuBagDisplay(SpriteScreen):
    def __init__(self, size, scale, game):
        ...
        self.container = ItemSetContainer(self.game.player.bag, scale=scale)
