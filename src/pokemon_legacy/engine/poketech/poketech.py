...
from pokemon_legacy.engine.graphics.font.font import ClockFont
from pokemon_legacy.engine.graphics.screen_V2 import BlitLocation
...
class PoketechButton(pg.sprite.Sprite):
    def __init__(self, scale=1.0):
        ...
        self.image = pg.image.load(MODULE_PATH / 'assets/button.png')
...
class ClockDisplay(SpriteScreen):
    def __init__(self, size, scale=1):
        ...
        self.load_image(MODULE_PATH / "assets/clock_background.png", base=True, scale=scale)
...
class PedometerDisplay(SpriteScreen):
    def __init__(self, size, scale: float = 1.0):
        SpriteScreen.__init__(self, size)
        self.load_image(MODULE_PATH / "assets/pedometer_background.png", base=True, scale=scale)
...
class TeamDisplay(SpriteScreen):
    ...
    hp_outline = pg.image.load(MODULE_PATH / 'assets/hp_outline.png')
    hp_infill = pg.image.load(MODULE_PATH / 'assets/hp_infill.png')

    def __init__(self, size, team: Team, scale: float = 1.0):
        SpriteScreen.__init__(self, size)
        self.load_image(MODULE_PATH / "assets/blank_background.png", base=True, scale=scale)
...
class Poketech(SpriteScreen):
    def __init__(self, size, time, team, scale=1):
        SpriteScreen.__init__(self, size)
        self.load_image(MODULE_PATH / "assets/poketech_base.png", base=True, scale=scale)
    ...
    def _load_surfaces(self):
        ...
        self.load_image(MODULE_PATH / "assets/poketech_base.png", base=True, scale=self.scale)
